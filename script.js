...
function calculateWPM() {
  ...
  const wordCount = textToType.innerText.split(" ").length; 
  const wpm = Math.floor((wordCount / timePassed) * 60);
...
// Initialize the word limit selection and generate initial text
totalWordsToType();
wordLimit = text;  // Default to the 50-word array
testGenerator();
